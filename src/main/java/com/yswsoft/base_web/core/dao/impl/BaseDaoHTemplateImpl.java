...
import com.yswsoft.base_web.core.dao.BaseDaoHTemplate;
...
public class BaseDaoHTemplateImpl<T> implements BaseDaoHTemplate<T> {
	@Autowired
	...
	*//**
	...
	@Override
	public List<?> findTByName(String name,Object value) {
		return hibernateTemplate.findByNamedQuery(name, value);
	}
}
*/